# INSTRUCTIONS
# ============
# You must copy this file into ~/.oh-my-zsh/custom/plugins/fzf_flatpak_widget/
# Commands:
#   mkdir -p ~/.oh-my-zsh/custom/plugins/fzf_flatpak_widget/
#   cp ~/Chest/Dots/fzf_flatpak_widget.plugin.zsh ~/.oh-my-zsh/custom/plugins/fzf_flatpak_widget/
#
# Then, add fzf_flatpak_widget to zshrc plugins.
#
# This plugin was copied as-is from:
