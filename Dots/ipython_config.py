...
#  Default: "Python 3.11.9 (main, Apr 14 2024, 15:13:47) [GCC 11.4.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.11.9 (main, Apr 14 2024, 15:13:47) [GCC 11.4.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.11.9 (main, Apr 14 2024, 15:13:47) [GCC 11.4.0]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#=============================================================================#
'''
Due to the *inspired* and *inclusive*, unreviewed, massive coloring changes
from:

- a0f8293
  - `Carreau:colors`
    'Slowly work on ultratb and debugger to use tokens and pygments. #14692'
  - https://github.com/ipython/ipython/pull/14692

Everyone's pygments-based styling has been broken (pygments is still what
ipython continues to use under the hood).

The hack suggested by a ipython maintainer in:
[What is the replacement for highlighting_style? #14809](
https://github.com/ipython/ipython/issues/14809)

is:
> This in your config file should create a new theme derived from the
> linux_theme:
> ```
