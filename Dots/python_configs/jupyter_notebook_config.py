...
#  Default: True
# this gets annoying--you can just as easily open from clicking the url
...
# 8888 is too common, pick soemthing else
#&&&c.NotebookApp.port = 80085
...
#  is NOT RECOMMENDED.
#  Default: '<generated>'
# we run local so it is just a fucking nuisance
c.NotebookApp.token = ''
...
#  Choices: any of ['blake2b', 'sha3_512', 'sha1', 'sha224', 'sha3_256', 'blake2s', 'md5', 'sha3_384', 'sha256', 'sha384', 'sha3_224', 'sha512']
#  Default: 'sha256'
